#1.12.3
from os import remove,rename,scandir,listdir,environ
...
from time import sleep,localtime,gmtime,time
...
def d():
    b36()
    a2.delete('1.0','end')
    a2.place(x=90,y=50,height=200,width=400)
    a9.place(x=260,y=270)
def e():
    try:
...
def a1():
    b36()
    a2.place(x=25,y=45,height=280,width=550)
    a3.place(x=20,y=10)
    a4.place(x=520,y=10)
def a5():
    a7=a2.get('1.0','end')
...
def a35():
    if not a28:
        ...
        return False
    b36()
    a42.place(x=70,y=255)
    a43.place(x=70,y=210)
    a43.select()
    a44.place(x=70,y=165)
    a45.place(x=70,y=120)
    a46.place(x=70,y=75)
    a47.place(x=70,y=30)
    a54.place(x=500,y=200,width=70)
    a57.place(x=190,y=280)
def a12():
...
def a05():
    b36()
    a06.place(x=120,y=40)
    a07.place(x=165,y=130)
    a08.place(x=163,y=190)
    a09.place(x=170,y=250)
    a30.place(x=280,y=130)
    b54.place(x=282,y=190)
...
def a56():
    ...
    if s is 5:
        ...
        a61.place(x=40,y=40)
        a74.place(x=40,y=80)
        a75.place(x=40,y=120)
        a76.place(x=40,y=160)
        a77.place(x=40,y=200)
        a78.place(x=40,y=240)
        a79.place(x=150,y=160)
        a80.place(x=150,y=40)
        a81.place(x=150,y=80)
        a82.place(x=150,y=120)
        a83.place(x=240,y=300)
        a84.place(x=277,y=300)
        a86.place(x=40,y=295)
        return 0
    a92()
def a92(s):
    b36()
    a93.place(x=100,y=400,width=70,height=20)
    a94.place(x=180,y=400,width=40)
    a95.place(x=230,y=400,width=40)
def a96():
    a93.delete('1.0','end')
...
def b35():
    b36()
    b39.place(x=10,y=7)
    b43.place(x=80,y=150)
    b44.place(x=110,y=150,width=25)
    b45.place(x=140,y=150,width=25)
    b46.place(x=170,y=150,width=25)
    b38.place(x=120,y=30,height=60,width=60)
    b41.place(x=250,y=30,height=60,width=60)
def c71():
    global u
    if c70.get():
...
def b96():
    if not a28:
        ...
        return False
    b36()
    c02.place(x=270,y=250)
    c04.place(x=240,y=220,width=40)
    c06.place(x=290,y=170)
    c05.place(x=320,y=220,width=40)
    c00.place(x=230,y=150)
def b95():
    j()
...
def b85():
    ...
    s=Thread(target=b90)
    s.start()
    b88.place(x=210,y=20)
    b93.place(x=170,y=60)
    b91.place(x=250,y=55,width=30,height=30)
    b92.place(x=380,y=55,width=30,height=30)
    c21.place(x=250,y=100)
    c16.place(x=50,y=100)
    c19.place(x=150,y=100)
def b89():
    global b87,b79
    b79=time()
    b87=b86.get()
...
def b55():
    b59.place(x=120,y=50)
    b57.place(x=70,y=100,width=30)
    b58.place(x=115,y=100,width=30)
    b67.place(x=165,y=100,width=30)
    b68.place(x=213,y=100,width=30)
    b69.place(x=325,y=100,width=30)
    b70.place(x=370,y=100,width=30)
    b71.place(x=415,y=100,width=30)
    b72.place(x=465,y=100,width=30)
    b61.place(x=130,y=250,width=50)
    b62.place(x=400,y=250)
    b60.place(x=70,y=130)
    while b74:
        sleep(.0001)
...
def c07():
    b36()
    c08.place(x=280,y=15)
    c09.place(x=293,y=275)
    c2.place(x=300,y=30)
def c15():
    speed(0)
    colormode(255)
...
def c6():
    b36()
    c7.place(x=30,y=30)
    c67.place(y=120,x=30)
    c69.place(x=150,y=30)
    c84.place(x=300,y=30)
    c86.place(x=300,y=60)
    c88.place(x=30,y=5)
    c90.place(x=150,y=100)
    c94.place(x=450,y=30)
def c92():
...
def c30():
    ...
    c31.place(x=30,y=20)
    c32.place(x=110,y=22,width=30)
    c33.place(x=230,y=15)
    c37.place(x=350,y=20)
    c36.pack(side=LEFT)
    c65.config(command=c36.yview)
    c42.place(x=440,y=20)
    c44.place(x=490,y=60,width=70)
    c45.place(x=490,y=100,width=70)
    c49.place(x=490,y=150,width=70)
    c51.place(x=490,y=200,width=70)
    global c40
    c40=True
    while c40:
        for i in a28:
...
def c53():
    b36()
    c54.place(x=20,y=10)
    c55.place(x=25,y=50,width=550,height=230)
    c56.place(x=300,y=290)
    c57.place(x=30,y=290)
def c58():
    pass
def c59():
    pass
